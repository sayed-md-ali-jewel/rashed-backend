...
export interface ApiAppointmentAppointment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fee: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    patientMessage: Schema.Attribute.Text;
    patientName: Schema.Attribute.String & Schema.Attribute.Required;
    paymentAmount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    paymentStatus: Schema.Attribute.Enumeration<
      ['pending', 'paid', 'failed', 'refunded', 'unpaid', 'partial']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pending'>;
    publishedAt: Schema.Attribute.DateTime;
    queueNumber: Schema.Attribute.Integer & Schema.Attribute.Required;
    reason: Schema.Attribute.Text;
    schedule: Schema.Attribute.Relation<'manyToOne', 'api::schedule.schedule'>;
    slotEnd: Schema.Attribute.DateTime;
    slotStart: Schema.Attribute.DateTime & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDoctorProfileDoctorProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutSection: Schema.Attribute.Component<'doctor.about-section', false>;
    contactSection: Schema.Attribute.Component<'doctor.contact-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroSection: Schema.Attribute.Component<'doctor.hero-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    profileDetailsSection: Schema.Attribute.Component<
...
export interface ApiHospitalHospital extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    embeddedMapUrl: Schema.Attribute.Text;
...
export interface ApiIncomeIncome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentMethod: Schema.Attribute.Enumeration<
      ['cash', 'card', 'bkash', 'nagad', 'bank', 'other']
    > &
...
export interface ApiPatientPatient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gender: Schema.Attribute.String;
    jwtSubject: Schema.Attribute.String & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::patient.patient'
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentMethod: Schema.Attribute.Enumeration<
      ['cash', 'card', 'bkash', 'nagad', 'bank', 'online', 'other']
    > &
      Schema.Attribute.DefaultTo<'cash'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statusCode: Schema.Attribute.Enumeration<['permanent301', 'temporary302']> &
      Schema.Attribute.DefaultTo<'permanent301'>;
...
export interface ApiScheduleSchedule extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Consultation Schedule';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    maxAppointments: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    ...
    seo: Schema.Attribute.Component<'seo.meta', false>;
    slotDurationMinutes: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiSeoSettingSeoSetting extends Struct.CollectionTypeSchema {
...
export interface ApiWebsiteSettingWebsiteSetting
  ...
  attributes: {
    appointmentSection: Schema.Attribute.Component<
      'website.appointment-section',
      false
    >;
    brandSection: Schema.Attribute.Component<'website.brand-section', false>;
    contactCtaSection: Schema.Attribute.Component<
      'website.contact-cta-section',
      false
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultSeo: Schema.Attribute.Component<'seo.meta', false>;
    googleMapsApiKey: Schema.Attribute.Password & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    mediaSection: Schema.Attribute.Component<'website.media-section', false>;
    profileSection: Schema.Attribute.Component<
      'website.profile-section',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    schedulesSection: Schema.Attribute.Component<
      'website.schedules-section',
      false
    >;
    smsProviderConfig: Schema.Attribute.Component<
      'shared.long-title-value',
      true
    > &
      Schema.Attribute.Private;
    socialLinksSection: Schema.Attribute.Component<
